...
$$1.summernote = $$1.extend($$1.summernote, {
    ...
    options: {
        ...
        icons: {
            ...
            'rowBelow': 'note-icon-undo',
            'colBefore': 'note-icon-minus',
            'colAfter': 'note-icon-menu-check',
            'rowAbove': 'note-icon-underline',
            'rowRemove': 'note-icon-unorderedlist',
            'colRemove': 'note-icon-orderedlist',
            'indent': 'fa fa-indent',
